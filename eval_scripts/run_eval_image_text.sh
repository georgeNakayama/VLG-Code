...
CUDA_VISIBLE_DEVICES=3,4 \
    ...
    experiment.run_name=garmentcodedata.llava-7b.regression.r8.kv.lr6e-4.pos.sinusoidal_0.multimodal.eval.image_text1 \
    ...
    'data_wrapper.dataset.sampling_rate=[0,0,0,1,0]' data_wrapper.dataset.editing_flip_prob=0 \
    ...
    hydra.run.dir=/miele/george/garment/sewformer/outputs/eval_image_text1 \
